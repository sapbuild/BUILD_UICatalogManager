...
router.post('/importcatalog', acl.checkAllowed(2, auth.getUserId),multipartMiddlewareLib,controller.importCatalog);
...
router.get('/catalog/catalognames/:catalogNames(*)', acl.checkAllowed(2, auth.getUserId), controller.getCatalogsByName);
router.get('/libtype/:libType/getuilibversions', acl.checkAllowed(2, auth.getUserId), controller.getAvailableVersions);
router.get('/getAllLibrariesAndVersions', acl.checkAllowed(2, auth.getUserId), controller.getAllLibrariesAndVersions);
