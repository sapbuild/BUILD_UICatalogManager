...
UICatalogRestApi.prototype.getSapUiCorePreloaded = function (httpCodeExpected, fnCallBack) {
    ...
    this.normanTestRequester.reqGet('/api/uicatalogs/public/uilib/openui5/1.26.6/sap-ui-core-preloaded.js', httpCodeExpected, fnCallBack);
};
UICatalogRestApi.prototype.getSapUiMergedLibrariesCSS = function (httpCodeExpected, fnCallBack) {
