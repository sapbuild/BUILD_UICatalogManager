...
function constructControls(tree, type, version, isPrivate) {
    ...
    var visiblity = isPrivate ? 'private' : 'public';
    catalogJsonParent.libraryURL = '/api/uicatalogs/' + visiblity + '/uilib/' + type + '/' + version.replace(/\./g, '<;dot;>');
